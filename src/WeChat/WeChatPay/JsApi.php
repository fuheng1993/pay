...
use EasySwoole\Pay\WeChat\ResponseBean\JsApi as JsApiResponse;
 ...
 */
class JsApi extends AbstractPayBase
{
     ...
     */
    public function pay(Base $bean): JsApiResponse
    {
        ...
        $response = new JsApiResponse($result);
